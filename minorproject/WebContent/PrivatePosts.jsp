 ...
 <div id="navbar">
    <div id="nav">
         <ul id="ul">
             ...
             <li><a class="active" href="">PRIVATE DISCUSSION</a></li>
    ...
    <div class="container">
         <section>
            <div id="container_demo" >
                 <div id="wrapper">
                  <h1>Private Posts in <%=A.getBranch() %> Department</h1>
                   <p><br>
                    
                   <%
                    
                    Post P=new Post();
                     ResultSet rs=PostController.DisplayPrivatePostByDepartment(A.getBranch());
