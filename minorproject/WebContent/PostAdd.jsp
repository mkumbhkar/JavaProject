                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form action="PostSubmit" autocomplete="on"> 
                                <h1>Add your Post</h1> 
                                <p> 
                                   <label for="" class="" > Post Title </label>
                                    <input id="newpost" name="posttitle" required="required" type="text" placeholder="post title"/>
                               </p>
                                <p> 
                                     <label for="" class="" > Post Privacy </label>
                                     <select id="privacy" name="postprivacy" ><option>Select</option><option>Public</option><option>Private</option></select>>         
                                </p>
                                <p> 
                                ...
                                <p>
                                      ...
                                      <textarea rows="10" cols="60" id="postcontent" name="postcontent">Write Here...</textarea>
