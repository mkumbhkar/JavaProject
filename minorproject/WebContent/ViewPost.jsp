...
<div id="navbar">
    <div id="nav">
         <ul id="ul">
             ...
             <li><a class="active" href="">YOUR POST</a></li>
                 ...
                 <div id="wrapper">
                  <h1>Your Posts</h1>
                   ...
                   <%
                    ...
                    Client A;
                 	try{
                 		ses.putValue("SCREATE","DisplayPost.jsp");
                 	A=(Client)ses.getValue("SCLIENT");	
                 	String ltime=(String)ses.getValue("SLTIME");
                    Post P=new Post();
                     ResultSet rs=PostController.DisplayPostByUserID(A.getUserid());
                    %>
