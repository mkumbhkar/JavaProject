                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                         <%
                           ...
                           ses.putValue("SCOMMENT", "DisplayPost.jsp");
                            %>
                            <b>USER:</b><%out.print(A.getUsername()); %></br>
                              ...
                              while(rs.next())
                              {
                               %>
                                <b><%out.print(rs.getString(6));%></b>&nbsp;&nbsp;&nbsp;
                                 <%out.print(rs.getString(4));%>&nbsp;&nbsp;<a href='CommentDelete?commentid="<%out.print(rs.getString(1));%>"'><i>DELETE</i></a><br>
                              <%  } 
